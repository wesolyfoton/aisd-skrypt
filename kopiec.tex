...
\comment{Numerujmy elementy w tablicy od zera.
Niby nic takiego, ale:
1) ułatwia to potem implementację w języku programowania
2) na liście kiedyś pojawi się zadanie w którym kopce będzie się definiowało jako coś co ma d-synów i wtedy się okaże, że lepiej numerować od zera.}
...
Synami węzła o indeksie $i$ są węzły $2i$ oraz $2i + 1$, natomiast jego ojcem jest $\left\lfloor \frac{i}{2} \right\rfloor$.
