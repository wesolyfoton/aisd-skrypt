...
Każdy z przedmiotów typu $i\in \mathbb{N}_+$ ma swoją wartość $v_i> 0$ i wielkość $w_i> 0$.
To ile przedmiotów typu $i$ zabierzemy będziemy oznaczać przez $x_i\in \mathbb{N}$.
...
Specyfikacja jest analogiczna do wariantu dyskretnego, z tą różnicą, że $x_i \in \mathbb{R}_+ \cup \left \{ 0 \right \}$.
