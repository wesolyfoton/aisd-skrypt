...
\begin{definition}
\textbf{Lewym/Prawym Kręgosłupem} drzewa nazywamy cieżkę od korzenia do wierzchołka z najmniejszym/największym kluczem (złożoną wyłącznie z lewych/prawych krawędzi).
\end{definition}
\end{proof}
