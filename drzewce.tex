...
Teraz, gdyby $y$ nie należał do prawego kręgosłupa lewego poddrzewa $x$ to musiałby istnieć $z$ t.że $y.key < z.key < x.key$ i $y.priority > z.priority$, co daje sprzecznoć.
