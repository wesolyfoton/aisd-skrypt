...
\begin{algorithm}[h]
  ...
  {
   	wykonaj procedurę \texttt{Dziel\_i\_zwyciężaj} rekurencyjnie dla $i$-tego podproblemu
  }
...
Nie wiem czy to powinien być osobny akapit, tabelka czy może coś jeszcze innego.}
